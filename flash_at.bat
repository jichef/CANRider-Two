...
%ESPTOOL% --chip esp32 --port %PORT% --baud 921600 --before default_reset --after hard_reset write_flash -z --flash_mode dio --flash_freq 80m --flash_size 4MB 0x1000 "%SKETCH_DIR%\AT.ino.bootloader.bin" 0x8000 "%SKETCH_DIR%\AT.ino.partitions.bin" 0xe000 %BOOT_APP0% 0x10000 "%SKETCH_DIR%\AT.ino.bin"
